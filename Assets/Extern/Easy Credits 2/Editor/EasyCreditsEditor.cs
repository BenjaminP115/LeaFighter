...
namespace Onerat.EasyCredits
{
    ...
    public class EasyCreditsEditor : Editor
    {
        ...
        [SerializeField]
        private bool togglePresets ,toggleCentering, toggleSectionSpacing, toggleGameTitle, toggleRoles, toggleTitles, toggleSettings, toggleLeagal, toggleInlays;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label("Easy Credits 2.01 - Created By @oneratdylan", stylePreset);
